#Occupancy_Pre_Processing_Analysis.R

occupancyAnalysis <- occupancyPreProcessed
head(occupancyAnalysis)
sapply(occupancyAnalysis, "class")
...
#Plot Day
plot(x = occupancyAnalysis$Day, y = occupancyAnalysis$Temperature,
